...
class Beer extends Base
{
    ...
    public function beerHop()
    {
        return static::randomElement(static::$hops);
    }

    public function beerYeast()
    {
        return static::randomElement(static::$yeasts);
    }

    public function beerMalt()
    {
        return static::randomElement(static::$malts);
    }

    public function beerStyle()
    {
        return static::randomElement(static::$styles);
    }
}